...
export const agentSchema = z.object({
   ...
   * only way to surface it without replacing the shipped picker. Off by default,
   * because it changes what the model is called everywhere the name appears.
   */
  showCredit: z.boolean().default(false),
})
