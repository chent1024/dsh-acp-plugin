...
// A minimal-PATH case does NOT belong here: this file spawns with
// `process.execPath`, an absolute path, so the child never consults PATH and the
// case would pass with or without the fix. It was tried here first and proved
// nothing. `tests/app-conditions.test.js` covers it with a launcher that really
// does resolve `node` through PATH.
